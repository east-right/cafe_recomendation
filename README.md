...
> 해당 시스템의 핵심 Reference [CogRec: A Cognitive Recommender Agent Fusing Large Language Models and Soar for Explainable Recommendation](https://arxiv.org/abs/2512.24113)
---
...
1. 질문이 들어오면 `select_keuword`에서 질문과 관련이 높은 키워드 선택
